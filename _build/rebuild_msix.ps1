...
Remove-Item 'CVToposheet_1.0.0.0_x64.msix' -Force -ErrorAction SilentlyContinue
...
& $makeappx pack /d 'msix_staging' /p 'CVToposheet_1.0.0.0_x64.msix' /nv /o

if (Test-Path 'CVToposheet_1.0.0.0_x64.msix') {
    $size = [math]::Round((Get-Item 'CVToposheet_1.0.0.0_x64.msix').Length / 1MB, 1)
